...
void is_sm_et(realtype t, realtype stepsize, void *DS,N_Vector VY)
	...
	#if !defined(SURF_RIV) || !defined(NO_UNSAT)
...
//		MD->EleNetPrep[i] = MD->ElePrep[i];		//For situation with melt flux input from ISNOBAL_Xing20150621
//              MD->EleET[i][0] = 0;                            //For situation with melt flux input from ISNOBAL_Xing20150621
